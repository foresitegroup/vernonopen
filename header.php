...
<head>
  ...
  <script>
    ...
    ga('create', 'UA-46128630-1', 'vernonopen.com');
    ga('send', 'pageview');
  </script>
...
<div id="header"> <!-- BEGIN header -->
  ...
  <div id="headerband"></div> <!-- Opaque band on bottom of header -->
</div> <!-- END header -->
...
<div id="content"> <!-- BEGIN content -->
  ...
  <div id="minheight"></div> <!-- Minimum height hack for older versions of IE -->
  
  <img src="images/threepix.gif" alt="" style="float: right;"> <!-- Three stack pictures on right -->
  
  <div id="two-col"> <!-- BEGIN two column wrap -->
